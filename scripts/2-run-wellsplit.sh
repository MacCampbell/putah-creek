...
#SBATCH --output=%A-%a.out # File to which STDOUT will be written
#SBATCH --error=%A-%a.err # File to which STDERR will be written
...
# the script must be run with three column file generated by commands in 1-set-up-wellsplit.sh
